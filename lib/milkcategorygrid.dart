...
import 'milkproductgrid.dart';
import 'package:hexadairy_milkapp/productmilk.dart';
import 'package:hexadairy_milkapp/homepagetry1.dart';
import 'package:hexadairy_milkapp/profile.dart';



class milkgrid extends StatefulWidget {
  @override
  State<milkgrid> createState() => _milkgridState();
}

class _milkgridState extends State<milkgrid> {
  final List<Map<String, String>> categories = [
    {"name": "Full Cream Milk", "image": "assets/images/fullfat.jpeg"},
                  ...
                  GestureDetector(
                    ...
                    child:ClipRRect(
                      ...
                      footer: GridTileBar(
                        ...
                        title: Text(categories[i]['name']!,textAlign: TextAlign.center,),
                      ),
                    ),
                  ),
            ),
